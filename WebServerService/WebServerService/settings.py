"""
Django settings for WebServerService project.
...
SECRET_KEY = 'django-insecure-&c_l-huq78u1x6%h98=d0b9_!#%v5$pa4kwr^b355iz+z4o3p#'
...
ROOT_URLCONF = 'WebServerService.urls'
...
WSGI_APPLICATION = 'WebServerService.wsgi.application'
...
STATICFILES_DIRS = [os.path.join(BASE_DIR, "gps_score_app", "static")]
